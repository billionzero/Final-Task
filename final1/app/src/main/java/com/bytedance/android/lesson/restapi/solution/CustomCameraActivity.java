...
//        refresh.setData(Uri.fromFile(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES)));
                CustomCameraActivity.this.sendBroadcast(refresh);
            }
        });
        button.setEnabled(false);

        final Button button1=findViewById(R.id.btn_record);
...
//                findViewById(R.id.btn_record).
                    CustomCameraActivity.this.prepareVideoRecorder();
        ...
        findViewById(R.id.btn_zoom).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(CustomCameraActivity.this, "调焦中...", Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(CustomCameraActivity.this, "手机不支持调焦" + e, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
